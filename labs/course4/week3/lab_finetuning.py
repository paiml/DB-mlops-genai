...
# MAGIC
# MAGIC EXERCISE: Implement LoRA configuration class.
...
# MAGIC
# MAGIC EXERCISE: Implement training configuration.
...
# MAGIC
# MAGIC EXERCISE: Create a dataset preparation pipeline.
...
class DatasetPreparer:
    ...
    def add_sample(self, instruction: str, input: str, output: str) -> None:
        ...
        # EXERCISE: Create and store TrainingSample
        # YOUR CODE HERE
        pass

    def add_from_dict(self, data: Dict) -> None:
        """Add sample from dictionary."""
        # EXERCISE: Extract fields and call add_sample
        # YOUR CODE HERE
        pass

    def format_all(self, format_type: str = "alpaca") -> List[str]:
        """Format all samples."""
        # EXERCISE: Return list of formatted prompts
        # YOUR CODE HERE
        pass

    def split(self, train_ratio: float = 0.9) -> tuple:
        """Split into train/eval sets."""
        # EXERCISE: Return (train_samples, eval_samples)
        # YOUR CODE HERE
        pass

    def save_jsonl(self, path: str) -> None:
        """Save samples as JSONL."""
        # EXERCISE: Write samples to file
        # YOUR CODE HERE
        pass
...
# MAGIC
# MAGIC EXERCISE: Create a complete fine-tuning configuration.
