...
# MAGIC
# MAGIC EXERCISE: Implement a Tokenizer class with encode/decode methods.
...
class Tokenizer:
    ...
    def __init__(self, vocab: Dict[str, int]):
        self.vocab = vocab
        # EXERCISE: Create reverse vocabulary (id -> word)
...
# MAGIC
# MAGIC EXERCISE: Implement token counting for cost estimation.
...
# MAGIC
# MAGIC EXERCISE: Implement batch encoding with padding.
...
# MAGIC
# MAGIC EXERCISE: Analyze tokenization of a corpus.
