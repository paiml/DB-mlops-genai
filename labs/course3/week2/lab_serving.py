...
# EXERCISE: Get your registered model
...
# EXERCISE: Create endpoint with your model
...
# MAGIC
# MAGIC EXERCISE: Send prediction requests to the endpoint.
...
# MAGIC
# MAGIC EXERCISE: Process multiple batches and track metrics.

# COMMAND ----------

# EXERCISE: Send 100 batch requests and track latency
...
# MAGIC
# MAGIC EXERCISE: Analyze prediction latencies.

# COMMAND ----------

# EXERCISE: Calculate latency statistics
# - Average latency
# - p50 latency
# - p99 latency
