...
# MAGIC
# MAGIC EXERCISE: Create a new experiment using the MLflow client.

# COMMAND ----------

# EXERCISE: Create a new experiment
# Hint: Use client.create_experiment() or mlflow.set_experiment()

experiment_name = "/Users/YOUR_NAME/lab-1-4-experiment"  # EXERCISE: Update with your name
...
# MAGIC
# MAGIC EXERCISE: Start a run and log parameters and metrics.

# COMMAND ----------

# EXERCISE: Start a run and log data
...
# MAGIC
# MAGIC EXERCISE: Search for runs and display their metrics.

# COMMAND ----------

# EXERCISE: Search for runs in your experiment
